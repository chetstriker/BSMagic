...
function JAnimate(JCurTab,JNewTab,BSObject,parameters){
    ...
    div.style.top = parseInt(JCurtRect.top) + parseInt(parameters.navOffsetY) - 3 + 'px'; // 3 subtracted to add for padding in css
